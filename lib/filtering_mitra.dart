import 'package:elangv2_jdk19/detail_mitra.dart';
...
class _FMState extends State<FilteringMitra> {
  ...
  Future<void> fetchFOData() async {
    final url =
        '$baseURL/api/v1/mitra/partner-name?brand=${widget.brand}&category=${widget.category}&mc=${widget.mcName}';
    try {
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: _FMData.isNotEmpty
                                  ? ListView.builder(
                                      itemCount: _searchText.isEmpty
                                          ? _FMData.length
                                          : _filteredFMData.length,
                                      itemBuilder: (context, index) {
                                        final fm = _searchText.isEmpty
                                            ? _FMData[index]
                                            : _filteredFMData[index];
                                        return Container(
